...
Collective and Rongorongo Collective projects' own discipline (which this
folder is scaffolded directly from), a procedure is written from a real,
verified incident, not speculatively. This project has not run long enough
to have had one yet.
